...
const Name = player_information(info, "h1", "Name : Bilal Saeed Malik");
const Roll_No = player_information(info, "h1", "Roll-No : 1234");
const Score = player_information(
  info,
  "h1",
  "Score : <span id=`score`>10</span>"
);
